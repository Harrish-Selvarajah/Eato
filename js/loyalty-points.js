...
function renderActivity() {
    ...
    loyaltyArray.forEach(function (item) {
        ...
        <div style="text-align: center;"><span class="subtitle">You earned ${item.points} points</span> <br><span style="color: #5C5C5C;" class="primaryText"> Rs ${item.price} at ${item.via}</span></div>
